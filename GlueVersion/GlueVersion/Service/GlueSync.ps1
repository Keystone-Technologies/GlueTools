...
$serviceDisplayName = "GlueVersion Sync Utility"
$ServiceDescription = "This service polls IT Glue for changes to assets monitored by GlueVersion jobs."
